...
int firstVal, firstRow, secondVal, secondRow;
char firstCol, secondCol;
int i, j;
int Num_Card, Player, HitPair;

int pairsPlayer1, pairsPlayer2, Winner;
...
int printMenu_C() {
	...
	printf("|                               6. Open Pair                                  |\n");
	printf("|                               7. Open Pairs Continuous                      |\n");
	printf("|                               8. Open 2 Players                             |\n");
	printf("|                               9. Play                                       |\n");
	printf("|                                                                             |\n");
	printf("|                               0. Exit                                       |\n");
	printf("|                                                                             |\n");
...
int main(void) {
	...
	while (opc != '0') {
		...
		case '9':				//Open Pairs Continuous
			...
			if (Winner == 0)
			{
				gotoxy_C(18, 39);		//Situar el cursor a sota del tauler
				printf("NO WINNER");
			}
			else
				if (Winner == 1)
				{
					gotoxy_C(19, 36);		//Situar el cursor a sota del tauler
